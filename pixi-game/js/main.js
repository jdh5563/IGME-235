...
function createLabelsAndButtons() {
    ...
    let startLabelTop = new PIXI.Text("Circle Blast!");
    startLabelTop.style = new PIXI.TextStyle({
        fill: 0xFFFFFF,
        fontSize: 40,
        fontFamily: "Press Start 2P",
        stroke: 0xFF0000,
    ...
    startLabelTop.x = 50;
    startLabelTop.y = 120;
    startScene.addChild(startLabelTop);

    // 1B - make the middle start label
    let startLabelMid = new PIXI.Text("R U worthy..?");
    startLabelMid.style = new PIXI.TextStyle({
        fill: 0xFFFFFF,
        fontSize: 24,
        fontFamily: "Press Start 2P",
        fontStyle: "italic",
    ...
    startLabelMid.x = 185;
    startLabelMid.y = 300;
    startScene.addChild(startLabelMid);
...
function gameLoop() {
    ...
    let amt = 3 * dt; // at 60 FPS would move about 10% of distance per update
